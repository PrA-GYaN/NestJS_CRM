...
async function seedFirstTenantData() {
  ...
  try {
    ...
    const hashedCounselorPassword = await bcrypt.hash('Counselor@123456', 10);
    const hashedStudentPassword = await bcrypt.hash('Student@123456', 10);
          ...
          notes: [
            {
              ...
              matchedSLA: true,
              remarks: 'Initial seeded visa application',
            },
          ],
        },
      }));
