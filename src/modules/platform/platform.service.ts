...
export class PlatformService {
  ...
  async createTenant(createTenantDto: CreateTenantDto) {
    ...
    try {
      ...
      this.logger.error(
        `❌ Tenant provisioning failed for ${createTenantDto.subdomain}:`,
        errorMessage,
      );
  ...
  private async seedTenantDatabase(
    ...
    const defaultPassword =
      createTenantDto.adminPassword || process.env.TENANT_DEFAULT_PASSWORD || 'Admin@123456';
    ...
    await tenantPrisma.$transaction(async (tx) => {
      ...
      const superAdminRole = await tx.role.create({
        data: {
          ...
          name: 'SUPER_ADMIN',
          description:
            'Immutable super administrator with full system access - cannot be deleted or modified',
          isAdmin: true,
        },
      });
  ...
  private async createAllPermissions(prisma: any, tenantId: string) {
    const permissionsList = [
      ...
      { name: 'leads:assign', module: 'leads', action: 'assign', description: 'Assign leads' },
      {
        ...
        module: 'leads',
        action: 'convert',
        description: 'Convert leads to students',
      },
      ...
      },
      {
        ...
        module: 'universities',
        action: 'update',
        description: 'Update universities',
      },
      {
      ...
      },
      {
        ...
        module: 'universities',
        action: 'export',
        description: 'Export universities',
      },
      ...
      {
        name: 'visa-types:create',
        module: 'visa-types',
        action: 'create',
        description: 'Create visa types',
      },
      {
        name: 'visa-types:read',
        module: 'visa-types',
        action: 'read',
        description: 'View visa types',
      },
      {
        name: 'visa-types:update',
        module: 'visa-types',
        action: 'update',
        description: 'Update visa types',
      },
      {
        name: 'visa-types:delete',
        module: 'visa-types',
        action: 'delete',
        description: 'Delete visa types',
      },
      ...
      {
        name: 'scholarships:read',
        module: 'scholarships',
        action: 'read',
        description: 'View scholarships',
      },
      {
      ...
      {
        name: 'scholarships:delete',
        module: 'scholarships',
        action: 'delete',
        description: 'Delete scholarships',
      },
      {
        name: 'scholarships:export',
        module: 'scholarships',
        action: 'export',
        description: 'Export scholarships',
      },
      ...
      },
      {
        ...
        module: 'landing-pages',
        action: 'update',
        description: 'Update landing pages',
      },
      {
        name: 'landing-pages:delete',
        module: 'landing-pages',
        action: 'delete',
        description: 'Delete landing pages',
      },
      {
        name: 'landing-pages:publish',
        module: 'landing-pages',
        action: 'publish',
        description: 'Publish landing pages',
      },
    ];
