...
export class WorkflowsController {
  ...
  @ApiResponse({ status: 201, description: 'Workflow created successfully', type: WorkflowResponse })
  ...
  @ApiResponse({ status: 200, description: 'Returns list of workflows for the visa type', type: WorkflowResponse })
  @ApiResponse({ status: 404, description: 'Visa type not found' })
  ...
  @ApiResponse({ status: 200, description: 'Returns workflow details with steps', type: WorkflowResponse })
  ...
  @ApiResponse({ status: 200, description: 'Workflow updated successfully', type: WorkflowResponse })
  @ApiResponse({ status: 404, description: 'Workflow not found' })
  async updateWorkflow(
    ...
    const workflow = await this.workflowsService.updateWorkflow(tenantId, params.id, updateWorkflowDto);
  ...
  @ApiResponse({ status: 200, description: 'Workflow deleted successfully', type: WorkflowResponse })
  @ApiResponse({ status: 404, description: 'Workflow not found' })
  ...
  @ApiResponse({ status: 201, description: 'Workflow step created successfully', type: WorkflowResponse })
  @ApiResponse({ status: 404, description: 'Workflow not found' })
  ...
  @ApiParam({ name: 'workflowId', description: 'Workflow ID' })
  @ApiResponse({ status: 200, description: 'Returns ordered list of workflow steps', type: WorkflowResponse })
  @ApiResponse({ status: 404, description: 'Workflow not found' })
  ...
  @ApiResponse({ status: 200, description: 'Returns workflow step details', type: WorkflowResponse })
  ...
  @ApiParam({ name: 'workflowId', description: 'Workflow ID' })
  @ApiParam({ name: 'stepId', description: 'Step ID' })
  @ApiResponse({ status: 200, description: 'Workflow step updated successfully', type: WorkflowResponse })
  @ApiResponse({ status: 404, description: 'Workflow step not found' })
  ...
  async updateWorkflowStep(
    ...
    const step = await this.workflowsService.updateWorkflowStep(tenantId, workflowId, stepId, updateStepDto);
    return WorkflowResponseFactory.updated(
      step,
  ...
  @ApiParam({ name: 'workflowId', description: 'Workflow ID' })
  @ApiParam({ name: 'stepId', description: 'Step ID' })
  @ApiResponse({ status: 200, description: 'Workflow step deleted successfully', type: WorkflowResponse })
  @ApiResponse({ status: 404, description: 'Workflow step not found' })
  ...
  @ApiParam({ name: 'workflowId', description: 'Workflow ID' })
  @ApiResponse({ status: 200, description: 'Workflow steps reordered successfully', type: WorkflowResponse })
  ...
  async reorderWorkflowSteps(
    ...
    const steps = await this.workflowsService.reorderWorkflowSteps(tenantId, workflowId, stepOrders);
    return WorkflowResponseFactory.updated(
      steps,
