...
export class CourseApplicationsController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Course application created successfully',
    type: CourseApplicationResponseDto,
  })
  ...
  @ApiResponse({
    status: 409,
    description: 'Duplicate application exists for this student and course',
  })
  create(
  ...
  @ApiOperation({
    ...
    description:
      'Get all course applications with optional filtering. Required permission: course-applications:read',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiResponse({
    ...
    type: PaginatedCourseApplicationsResponseDto,
  })
  @ApiResponse({ status: 401, description: 'Unauthorized - Missing or invalid JWT token' })
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Requires course-applications:read permission',
  })
  findAll(
    @TenantId() tenantId: string,
    @CurrentUser() user: any,
    @Query() query: StudentApplicationsQueryDto,
  ) {
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all course applications for a specific student. Required permission: course-applications:read',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a specific course application by ID. Students can only access their own application.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Update the status of a specific course application. Required permission: course-applications:update',
  })
  @ApiParam({ name: 'id', type: String, description: 'Course application ID (UUID)' })
  ...
  @ApiResponse({
    status: 403,
    description: 'Forbidden - Requires course-applications:update permission',
  })
  @ApiResponse({ status: 404, description: 'Application not found' })
  updateStatus(
    @TenantId() tenantId: string,
  ...
  @ApiOperation({
    ...
    description:
      'Delete a course application by ID. Required permission: course-applications:delete',
  })
  @ApiParam({ name: 'id', type: String, description: 'Course application ID (UUID)' })
  @ApiResponse({
    status: 200,
    description: 'Application deleted successfully',
    type: DeleteCourseApplicationResponseDto,
  })
  @ApiResponse({ status: 401, description: 'Unauthorized - Missing or invalid JWT token' })
