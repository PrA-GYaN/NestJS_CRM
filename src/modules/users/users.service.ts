...
export class UsersService {
  ...
  async assignPermissions(tenantId: string, roleId: string, dto: AssignPermissionsDto) {
    ...
    return {
      success: true,
      message: `Permissions assigned successfully with scope: ${defaultScope}`,
      scope: defaultScope,
  ...
  async assignPermissionsToRole(tenantId: string, roleId: string, dto: AssignPermissionsToRoleDto) {
    ...
    return {
      success: true,
      message: `${newPermissionIds.length} permission(s) assigned to role successfully with scope: ${dto.defaultScope || 'full'}`,
